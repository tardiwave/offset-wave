const frag = /* glsl */ `
    ...
    uniform float uTime;
    uniform vec2 uMouse;
    uniform float uForceSecondNoise;
    uniform float uZoom;
    ...
    float generateNoise(vec2 vUv, float time) {
        float noise = sin(pnoise(vec3(vUv * 1.2, time * 0.01)) * 50.0);
    ...
    void main() {
        ...
        float finalNoise = generateNoise(vUv * basePerlinNoise.r * uForceSecondNoise, uTime) * 1. + generateNoise(vUv * basePerlinNoise.r * uForceSecondNoise, uTime) * 11.;
